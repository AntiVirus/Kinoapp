...
class BiletController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('Bilet');
	...
	{
		$model=new Bilet('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Bilet']))
			$model->attributes=$_GET['Bilet'];
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='bilet-form')
		{
